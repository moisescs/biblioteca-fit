...
<body>
	...
	<div class="w3-main" style="margin-left: 250px;">
		...
		<div id="myTop" class="w3-top w3-theme w3-large" style="background-color: #0070AF">
			...
			<span id="myIntro" class="w3-hide w3-text-white">FIT: Biblioteca - Lista de Alunos</span>
		</div>

		<header class="w3-container w3-theme w3-padding-64"
			style="padding-left: 32px; background-color: #0070AF;">
			<h1 class="w3-xxxlarge w3-padding-16 w3-text-white">FIT: Biblioteca - Lista de Alunos</h1>
		</header>
			...
			<table class="w3-table-all w3-hoverable" style="width: 100%;">
				...
				<c:forEach var="aluno" items="${alunos}">
					<tr>
						...
						<td>${aluno.logradouro} ${aluno.numero}, CEP: ${aluno.cep}, ${aluno.bairro}, ${aluno.cidade} - ${aluno.uf}</td>
						<td>${aluno.ra}</td>
						<td>${aluno.usuario}</td>
						<td>${aluno.bloqueado}</td>
						<td>
							<a href="formUpAluno?ra=${aluno.ra}" class="w3-bar-item w3-button"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
							<a href="deletarAluno?ra=${aluno.ra}" class="w3-bar-item w3-button"><i class="fa fa-trash" aria-hidden="true"></i></a>						
						</td>
					</tr>
			  </c:forEach>
			</table>
