...
<body>
	...
	<div class="w3-main" style="margin-left: 250px;">
		<div id="myTop" class="w3-top w3-theme w3-large" style="background-color: #0070AF">
			<i class="fa fa-bars w3-button w3-hide-large w3-xlarge w3-text-white" onclick="w3_open()"></i> <span id="myIntro" class="w3-hide w3-text-white">FIT: Biblioteca - Cadastro de Revistas</span>
		</div>

		<header class="w3-container w3-theme w3-padding-64" style="padding-left: 32px; background-color: #0070AF;">
			<h1 class="w3-xxxlarge w3-padding-16 w3-text-white">FIT: Biblioteca - Cadastro de Revistas</h1>
		</header>

		<div class="w3-container w3-padding-32" style="padding-left: 32px">

			<h2>Cadastro de Revistas</h2>

			<p>Esta pagina deve ser usada para Cadastro de Revistas:</p>

			<form class="w3-form" method="post" action="inserirRevista">
				<article class="w3-row-padding">
					<div class="w3-half w3-margin-top">
						<label class="w3-label w3-text-black">Título da Revista:</label>
						<input class="w3-input w3-border" name="titulo" type="text" placeholder="Titulo da Revista" required maxlength="100"/>
					</div>
					<div class="w3-half">
						<p>
					...
					<div class="w3-half w3-margin-top">
						...
						<input class="w3-input w3-border" name="codigoRevista" type="number" placeholder="Informe o codigo" required maxlength="15">
					</div>
