				...
				<div class="w3-half">
					<div class="w3-container w3-red w3-padding-16">
						...
						<div class="w3-bar w3-container w3-centered">
							<a href="listarLivro" class="w3-bar-item w3-button w3-hover-none"><i class="fa fa-search fa-2x" aria-hidden="true"></i></a> 
							<a href="formCadLivro" class="w3-bar-item w3-button w3-hover-none"><i class="fa fa-plus fa-2x" aria-hidden="true"></i></a> <!--  -->
							<a href="listarLivro" class="w3-bar-item w3-button w3-hover-none"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
				<div class="w3-half">
					<div class="w3-container w3-blue w3-padding-16">
						<div class="w3-left">
							<i class="fa fa-address-book w3-xxxlarge"></i>
						</div>
						<div class="w3-right">
							<h3>Revistas</h3>
						</div>
						...
						<br>
						<div class="w3-bar w3-container w3-centered">
							<a href="listarRevista" class="w3-bar-item w3-button w3-hover-none"><i class="fa fa-search fa-2x" aria-hidden="true"></i></a> 
							<a href="cadRevista" class="w3-bar-item w3-button w3-hover-none"><i class="fa fa-plus fa-2x" aria-hidden="true"></i></a> 
							<a href="listarRevista" class="w3-bar-item w3-button w3-hover-none"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
