...
<body>
	...
	<div class="w3-main" style="margin-left: 250px;">
		...
		<header class="w3-container w3-theme w3-padding-64"
			...
			<h1 class="w3-xxxlarge w3-padding-16 w3-text-white">FIT: Biblioteca - Lsta de Professores</h1>
		</header>
			...
			<table class="w3-table-all w3-hoverable" style="width: 100%;">
				...
				<c:forEach var="livro" items="${livros}">
					<tr>
						...
						<td>${prof.lograouro} ${prof.numero}, CEP: ${prof.cep}, ${prof.bairro}, ${prof.cidade} - ${prof.uf}</td>
						<td>${prof.re}</td>
						<td>${prof.usuario}</td>
						<td>${prof.bloqueado}</td>
						<td>
							<div class="w3-center">
								<a href="formUpLivro?isbn=${prof.re}" class="w3-button"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
								<a href="deletarLivro?isbn=${prof.re}" class="w3-button"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</div>						
						</td>
					</tr>
			  </c:forEach>
