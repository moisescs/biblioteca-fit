...
<body>
	...
	<div class="w3-main" style="margin-left: 250px;">
		...
		<div id="myTop" class="w3-top w3-theme w3-large" style="background-color: #0070AF">
			...
			<span id="myIntro" class="w3-hide w3-text-white">FIT: Biblioteca - Lista de Professores</span>
		</div>

		<header class="w3-container w3-theme w3-padding-64"
			style="padding-left: 32px; background-color: #0070AF;">
			<h1 class="w3-xxxlarge w3-padding-16 w3-text-white">FIT: Biblioteca - Lista de Professores</h1>
		</header>
		...
		<div class="w3-container w3-padding-32" style="padding-left: 32px">  <!-- Inicio do Container -->
			...
			<table class="w3-table-all w3-hoverable" style="width: 100%;">
				...
				<c:forEach var="prof" items="${profs}">
					<tr>
						<td>${prof.nomeCompleto}</td>
						<td>${prof.logradouro} ${prof.numero}, CEP: ${prof.cep}, ${prof.bairro}, ${prof.cidade} - ${prof.uf}</td>
						<td>${prof.re}</td>
						<td>${prof.usuario}</td>
						<td>${prof.bloqueado}</td>
						<td>
							<a href="formUpProf?re=${prof.re}" class="w3-bar-item w3-button"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
							<a href="deletarProf?re=${prof.re}" class="w3-bar-item w3-button"><i class="fa fa-trash" aria-hidden="true"></i></a>						
						</td>
					</tr>
			  </c:forEach>
			</table>
