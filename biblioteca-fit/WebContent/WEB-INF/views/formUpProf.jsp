...
<body>
	...
	<div class="w3-main" style="margin-left: 250px;">
		<div id="myTop" class="w3-top w3-theme w3-large" style="background-color: #0070AF">
			<i class="fa fa-bars w3-button w3-hide-large w3-xlarge w3-text-white" onclick="w3_open()"></i> <span id="myIntro" class="w3-hide w3-text-white">FIT: Biblioteca - Alteração de Professores</span>
		</div>

		<header class="w3-container w3-theme w3-padding-64" style="padding-left: 32px; background-color: #0070AF;">
			<h1 class="w3-xxxlarge w3-padding-16 w3-text-white">FIT: Biblioteca - Alteração de Professores</h1>
		</header>
		...
		<div class="w3-container w3-padding-32" style="padding-left: 32px">
			...
			<p>Esta pagina deve ser usada para Alteração de professores:</p>
				...
				<article class="w3-row-padding">
					...
					<div class="w3-half">
						<p>
							...
							<input class="w3-input w3-border" name="re" value="${prof.re}" type="number" placeholder="Informe o nº do RE" required maxlength="10">
						</p>
					</div>
					<div class="w3-half w3-margin-top">
					...
					<div class="w3-half w3-margin-top">
						...
						<input class="w3-input w3-border" name="usuario" value="${prof.usuario}" type="text" placeholder="Nome do usuário" required maxlength="10">
					</div>
					<div class="w3-half w3-margin-top">
