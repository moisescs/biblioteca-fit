			...
			<table class="w3-table-all w3-hoverable" style="width: 100%;">
				<thead>
					<tr class="w3-light-grey">
						...
						<th>Edição</th>
						<th>Editora</th>
						<th class="w3-center">Operações</th>
					</tr>
				</thead>
				<c:forEach var="rev" items="${revs}">
					<tr>
						<td>${rev.titulo}</td>
						<td>${rev.categoria}</td>
						<td>${rev.anoPublicacao}</td>
						<td>${rev.codigoRevista}</td>
						<td>${livro.edicao}</td>
						<td>${livro.editora}</td>
						<td>
							<div class="w3-center">
								<a href="formEmprestimoRevista?cod=${rev.codigoRevista}" class="w3-button"><i class="fa fa-retweet" aria-hidden="true"></i></a>
								<a href="formUpRevista?cod=${rev.codigoRevista}" class="w3-button"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
								<a href="deletarRevista?cod=${rev.codigoRevista}" class="w3-button"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</div>						
						</td>
					</tr>
			  </c:forEach>
